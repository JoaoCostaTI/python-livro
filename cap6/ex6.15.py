...
#Calculando numero de salas de cinema
numeroDeSalas = int(input('Quantas salas existem no cinema? '))
for c in range(numeroDeSalas):
    lugaresVagos.append(int(input(f'Sala {c + 1} - Lugares vagos: ')))
    ingressosVendidos.append(0)
